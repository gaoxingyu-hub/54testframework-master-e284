    ...
    def __init__(self, parent=None):
        ...
        if SystemLanguage.LANGUAGE == SystemLanguage.fr_FR:
            ...
            self.pic_file_path = os.path.join(
                SETUP_DIR, "imgs", "fr","ecom_ns", "ecom_ns_1")
        else:
            self.config_file_path = os.path.join(
                SETUP_DIR, "conf", "cn", "ecom_ns_1.json")
            self.pic_file_path = os.path.join(
                SETUP_DIR, "imgs", "cn","ecom_ns", "ecom_ns_1")
                ...
                for case, step in self.test_cases_records.items():
                    ...
                    for x in range(len(self.test_config.test_case)):
                        if case in self.test_config.test_case_detail[x]["title"]:
                            ...
                            if SystemLanguage.LANGUAGE == SystemLanguage.fr_FR:
                                self.pic_file_path = os.path.join(
                                    SETUP_DIR, "imgs", "fr","ecom_ns", self.test_config.test_case_detail[x]["case_name"])
                            else:
                                self.pic_file_path = os.path.join(
                                    SETUP_DIR, "imgs", "cn","ecom_ns", self.test_config.test_case_detail[x]["case_name"])
