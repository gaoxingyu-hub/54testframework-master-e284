...
class DialogTest11(QDialog, Ui_Dialog):
    ...
    def on_pushButton_next_clicked(self):
        ...
        if 30.025-500< mTemp[0] < 30.025+500 and 26 < mTemp[1] < 28:
            self.test_result.test_item = ModuleConstants.diantaifa_30025
            ...
            QMessageBox.information(self, ModuleConstants.tip, ModuleConstants.diantaifa_30025_pannel, QMessageBox.Ok)
            self.signalTest.emit('test')
