...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.tableWidget_test_results.setColumnCount(5)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_test_results.setHorizontalHeaderItem(4, item)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox_test_modules.setTitle(_translate("Dialog", "Éléments de test "))
        self.label_test_duration.setText(_translate("Dialog", "00:00:00"))
        self.treeWidget.headerItem().setText(0, _translate("Dialog", "1"))
        self.groupBox_test_resource.setTitle(_translate("Dialog", "Ressources de test "))
        ...
        item = self.tableWidget_test_results.horizontalHeaderItem(4)
        item.setText(_translate("Dialog", TransConstants.test_conclusion))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("Dialog", "VHF_radio test"))
